...
| **Email Comptable** | Drawer universel d'envoi au comptable via SMTP Gmail : sélection documents multi-type (exports, rapports, relevés, justificatifs, GED), filtres période, **expanders intelligents** (groupes ≥10 repliés), **pré-sélection intelligente** depuis Export, **jauge taille temps réel**, email HTML avec logo, ZIP unique en PJ, historique des envois |
